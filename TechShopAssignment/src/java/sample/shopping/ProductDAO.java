...
public class ProductDAO {
    ...
    private static String UPDATE = "UPDATE [dbo].[Product]\n"
            ...
            + "      ,[Description] = ?\n"
            + " WHERE Id = ?";
    private static String TOP3 = "SELECT TOP 3 *FROM [TechShopAssignmnet].[dbo].[Product]";
    private static String TOP4 = "SELECT TOP 4 *FROM [TechShopAssignmnet].[dbo].[Product] order by id desc";
