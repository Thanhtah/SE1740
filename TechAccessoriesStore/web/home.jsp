    ...
    <body class="biolife-body">
        ...
        <div class="page-contain">
            ...
            <div id="main-content" class="main-content">
                <h1 style="color: black; font-weight: 600;text-align: center; ">Home</h1>
                    ...
                    <div class="container">
                        <div class="biolife-tab biolife-tab-contain sm-margin-top-34px">
                            <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                                <h1 style="color: black; font-weight: 600; ">Newest Product</h1>
                                        ...
                                        <c:forEach var="p" items="${plist}">
                                            <li class="product-item col-lg-4 col-xs-6" style="min-height: 550px;">
                                                <div class="contain-product layout-default">
                                                    ...
                                                    <div class="info">
                                                        <h4 class="product-title"  style="margin-top: 25px;"><a style="color: black;" href="./ProductDetails?pid=${p.getId()}" class="pr-name">Name: ${p.getName()}</a></h4>
                                                        <div class="price">
                            ...
                            <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                                <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                    <li class="tab-element">
                                        <h1 style="color: black; font-weight: 600; ">Top seller</h1>
                                    </li>
